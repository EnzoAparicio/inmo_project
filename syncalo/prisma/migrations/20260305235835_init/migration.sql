-- CreateEnum
CREATE TYPE "Platform" AS ENUM ('AIRBNB', 'BOOKING', 'DIRECT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Channel_platform_propertyId_key" ON "Channel"("platform", "propertyId");

-- CreateIndex
CREATE UNIQUE INDEX "Booking_externalId_platform_propertyId_key" ON "Booking"("externalId", "platform", "propertyId");
